...
jQuery(document).ready(function(){
	...
	jQuery('.skin-color').click(function(){
		...
		if(jQuery('#skinstyle').length > 0) {
			if(s!='dark') {
				jQuery('#skinstyle').attr('href','/public/templates/admin/katniss/css/style.'+s+'.css');	
			...
			if(s!='dark') {
				jQuery('head').append('<link id="skinstyle" rel="stylesheet" href="/public/templates/admin/katniss/css/style.'+s+'.css" type="text/css" />');
				jQuery.cookie("skin-color", s, { path: '/' });
			}
		}
		return false;
	...
	if(jQuery.cookie('skin-color')) {
		...
		if(c) {
			jQuery('head').append('<link id="skinstyle" rel="stylesheet" href="/public/templates/admin/katniss/css/style.'+c+'.css" type="text/css" />');
