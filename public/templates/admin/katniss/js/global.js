...
jQuery(document).ready(function(){
    //bắt sự hiện nút add để show form
    jQuery('.btn.addForm').click(function(){
        if(jQuery('#add-form').is(':hidden'))
        {
            jQuery('#add-form').show()
                .addClass('animate0 fadeInRightBig')
    ...
    //bắt sự hiện nút add để show form
    jQuery('#add-form .closeForm').click(function(){
