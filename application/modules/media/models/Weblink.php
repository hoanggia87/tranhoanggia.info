<?php
class Weblink_Model_Weblink extends Zend_Db_Table{
	protected $_name = 'weblink';
	...
	public function listItem($arrParam = null, $options = null){
		...
		if($options['task'] == 'admin-list'){
			$select = $db->select()
						 ->from($this->_name.' AS n',array('id','title','status','order','created','full_image','is_hot','is_home','is_home_mobile'))
