	...
	public function getData(){
		if($this->checkError() != true){
			...
			if($this->_arrData['image'] != ''){
				...
				$this->_arrData['image'] = $upload->upload('image',$uploadDir. 'full/',array('task'=>'rename'),'themuasam_');
				//Resize
            ...
            while($this->_arrData['image1_'.$j.'_']!='')
            {
                if($this->_arrData['image1_'.$j.'_'] != ''){
    				...
    				$this->_arrData['image1_'.$j.'_'] = $upload->upload('image1_'.$j.'_',$uploadDir. 'full/',array('task'=>'rename'),'themuasam_');
    				//Resize
			...
			if($this->_arrData['map_image'] != ''){
				...
				$upload = new Zendvn_File_Upload();
				$uploadDir = $this->_arrData['controllerConfig']['Dir'];				
				$this->_arrData['map_image'] = $upload->upload('map_image',$uploadDir. 'full/',array('task'=>'rename'),'themuasam_');
				//Resize
