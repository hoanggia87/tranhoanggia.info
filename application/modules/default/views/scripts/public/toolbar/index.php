<?php 
	...
	//13. Edit Item - link - default/default/public/change-password
	$linkChangePassword = $this->baseUrl($this->currentController . '/change-password');
	$btnChangePassword = $this->cmsButton('Edit Item',$linkChangePassword,
										$this->imgUrl . '/toolbar/icon-32-save.png','submit');																																		
	switch ($this->arrParam['action']){
		...
		case 'info' : $strBtn = $btnEditItem . ' ' . $btnBack;
			  			break;	
  		case 'change-password' : $strBtn = $btnChangePassword . ' ' . $btnBack;
  						break;	
		default:	$strBtn = '';				  				  					  					  					  				
	}										
